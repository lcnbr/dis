...
let node3= (pos:(0.54, 0.54))
node(node3.pos)
edge(node1.pos,(0.00, -0.56),node0.pos,decoration:"arrow",angle:3.14rad)
cetz.draw.content((0.00, -0.68),angle:3.14rad,[q+k[0]])
cetz.draw.hobby((0.44, -0.61),(0.00, -0.62),(-0.43, -0.61),stroke:stroke,mark: (end: ">"))
edge(node0.pos,(-0.55, -0.00),node2.pos,decoration:"wave",angle:4.71rad)
cetz.draw.content((-0.67, -0.00),angle:4.71rad,[q])
...
cetz.draw.content((0.68, 0.85),angle:0.79rad,[p])
cetz.draw.hobby((0.57, 0.65),(0.89, 0.97),stroke:stroke,mark: (end: ">"))
})
