...
edge(node0.pos,(-0.56, 0.00),node2.pos,decoration:"wave",angle:4.71rad)
cetz.draw.content((-0.68, 0.00),angle:4.71rad,[q])
cetz.draw.hobby((-0.60, -0.43),(-0.62, 0.00),(-0.60, 0.43),stroke:stroke,mark: (end: ">"))
edge(node3.pos,(0.55, -0.00),node1.pos,decoration:"wave",angle:1.57rad)
cetz.draw.content((0.67, -0.00),angle:1.57rad,[q])
cetz.draw.hobby((0.60, 0.43),(0.61, -0.00),(0.60, -0.44),stroke:stroke,mark: (end: ">"))
...
cetz.draw.hobby((0.61, 0.44),(0.62, 0.00),(0.61, -0.43),stroke:stroke,mark: (end: ">"))
edge(node3.pos,(0.00, 0.55),node2.pos,decoration:"arrow",angle:0.00rad)
cetz.draw.content((0.00, 0.67),angle:0.00rad,[-p-q])
cetz.draw.hobby((0.44, 0.61),(0.00, 0.61),(-0.43, 0.60),stroke:stroke,mark: (end: ">"))
edge(node0.pos,(-1.00, -1.00),decoration:"arrow",angle:-2.36rad)
cetz.draw.content((-0.68, -0.85),angle:-2.36rad,[-k[0]])
cetz.draw.hobby((-0.89, -0.97),(-0.57, -0.65),stroke:stroke,mark: (end: ">"))
edge(node1.pos,(1.00, -1.00),decoration:"arrow",angle:2.35rad)
cetz.draw.content((0.86, -0.68),angle:2.35rad,[-k[0]])
cetz.draw.hobby((0.65, -0.57),(0.97, -0.89),stroke:stroke,mark: (end: ">"))
