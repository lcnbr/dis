...
cetz.draw.hobby((-0.61, -0.43),(-0.62, 0.00),(-0.61, 0.44),stroke:stroke,mark: (end: ">"))
...
edge(node3.pos,(0.00, 0.56),node2.pos,decoration:"arrow",angle:-0.00rad)
cetz.draw.content((0.00, 0.68),angle:-0.00rad,[-p-q])
cetz.draw.hobby((0.43, 0.61),(0.00, 0.62),(-0.43, 0.61),stroke:stroke,mark: (end: ">"))
edge(node0.pos,(-1.00, -1.00),decoration:"arrow",angle:-2.36rad)
cetz.draw.content((-0.68, -0.85),angle:-2.36rad,[-k[0]])
cetz.draw.hobby((-0.89, -0.97),(-0.57, -0.65),stroke:stroke,mark: (end: ">"))
edge(node1.pos,(1.00, -1.00),decoration:"arrow",angle:2.35rad)
...
cetz.draw.content((-0.85, 0.69),angle:5.50rad,[p])
cetz.draw.hobby((-0.97, 0.89),(-0.65, 0.57),stroke:stroke,mark: (end: ">"))
