...
edge(node2.pos,(-0.19, 0.32),node3.pos,decoration:"coil",angle:2.84rad)
...
cetz.draw.content((0.32, -0.22),angle:0.36rad,[k[3]])
cetz.draw.hobby((0.47, 0.03),(0.30, -0.16),(0.04, -0.14),stroke:stroke,mark: (end: ">"))
edge(node4.pos,(0.35, 0.34),node5.pos,decoration:"arrow",angle:3.71rad)
...
cetz.draw.content((0.58, -0.38),angle:1.75rad,[q])
...
cetz.draw.hobby((0.10, -0.01),(0.27, -0.32),(0.42, -0.63),stroke:stroke,mark: (end: ">"))
edge(node3.pos,(0.47, 0.89),node2.pos,decoration:"arrow",angle:3.91rad)
cetz.draw.content((0.39, 0.97),angle:3.91rad,[k[2]])
cetz.draw.hobby((0.70, 1.01),(0.42, 0.92),(0.34, 0.64),stroke:stroke,mark: (end: ">"))
edge(node2.pos,(0.70, 0.66),node3.pos,decoration:"coil",angle:-2.31rad)
cetz.draw.content((0.78, 0.58),angle:-2.31rad,[p+k[2]])
...
cetz.draw.content((0.31, 0.24),angle:-2.22rad,[p])
...
cetz.draw.hobby((-1.01, 0.70),(-0.91, 0.43),(-0.63, 0.35),stroke:stroke,mark: (end: ">"))
edge(node3.pos,(-0.31, 0.22),node4.pos,decoration:"arrow",angle:2.49rad)
cetz.draw.content((-0.23, 0.31),angle:2.49rad,[p])
...
cetz.draw.content((0.32, -0.36),angle:2.10rad,[q])
...
edge(node0.pos,(0.76, -0.13),node4.pos,decoration:"wave",angle:-1.66rad)
...
cetz.draw.hobby((-0.36, 0.84),(-0.60, 0.73),(-0.82, 0.60),stroke:stroke,mark: (end: ">"))
...
edge(node2.pos,(-0.80, 0.51),node3.pos,decoration:"coil",angle:5.51rad)
...
let node1= (pos:(-0.64, -0.64))
node(node1.pos)
let node2= (pos:(0.78, 0.89))
node(node2.pos)
let node3= (pos:(0.45, 0.53))
node(node3.pos)
...
edge(node3.pos,(0.74, 0.61),node2.pos,decoration:"arrow",angle:0.86rad)
edge(node2.pos,(0.50, 0.83),node3.pos,decoration:"coil",angle:0.79rad)
edge(node3.pos,(0.23, 0.27),node4.pos,decoration:"arrow",angle:0.86rad)
