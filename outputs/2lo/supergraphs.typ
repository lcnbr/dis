...
let node5= (pos:(1.00, 0.71))
node(node5.pos)
edge(node1.pos,(0.24, 0.93),node0.pos,decoration:"arrow",angle:-0.54rad)
cetz.draw.content((0.30, 1.03),angle:-0.54rad,[k(0)+k(1)])
...
cetz.draw.content((-0.85, -0.27),angle:4.69rad,[k(2)])
cetz.draw.hobby((-0.69, 0.07),(-0.49, -0.85),(0.43, -0.64),stroke:stroke,mark: (end: ">"))
edge(node2.pos,(-0.20, 0.78),node4.pos,decoration:"arrow",angle:3.58rad)
cetz.draw.content((-0.25, 0.88),angle:3.58rad,[k(2)+k(3)])
cetz.draw.hobby((0.74, -0.14),(-0.02, 0.89),(-0.46, -0.31),stroke:stroke,mark: (end: ">"))
...
cetz.draw.hobby((0.14, -0.54),(0.55, 0.32),(-0.39, 0.46),stroke:stroke,mark: (end: ">"))
