...
node(node5.pos)
edge(node1.pos,(0.24, 0.93),node0.pos,decoration:"arrow",angle:-0.53rad)
cetz.draw.content((0.30, 1.03),angle:-0.53rad,[k(0)+k(1)])
cetz.draw.hobby((-0.77, 0.76),(0.55, 0.70),(-0.06, -0.47),stroke:stroke,mark: (end: ">"))
...
edge(node5.pos,(0.22, 0.03),node2.pos,decoration:"arrow",angle:1.70rad)
cetz.draw.content((0.10, 0.01),angle:1.70rad,[k(3)])
cetz.draw.hobby((0.83, 0.79),(0.23, 0.41),(0.29, -0.30),stroke:stroke,mark: (end: ">"))
edge(node3.pos,(0.53, -0.14),node4.pos,decoration:"arrow",angle:1.22rad)
cetz.draw.content((0.64, -0.18),angle:1.22rad,[k(3)])
cetz.draw.hobby((-0.40, 0.46),(0.55, 0.33),(0.15, -0.53),stroke:stroke,mark: (end: ">"))
edge(node4.pos,(0.57, 0.41),node5.pos,decoration:"arrow",angle:3.85rad)
cetz.draw.content((0.49, 0.50),angle:3.85rad,[k(1)+k(3)])
cetz.draw.hobby((-0.08, -0.29),(0.31, 0.25),(0.83, 0.67),stroke:stroke,mark: (end: ">"))
})
...
edge(node5.pos,(0.22, 0.03),node2.pos,decoration:"arrow",angle:4.84rad)
cetz.draw.content((0.10, 0.01),angle:4.84rad,[k(3)])
cetz.draw.hobby((0.83, 0.79),(0.23, 0.41),(0.29, -0.30),stroke:stroke,mark: (end: ">"))
