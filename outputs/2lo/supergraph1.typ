...
edge(node0.pos,(-0.60, -0.37),node4.pos,decoration:"wave",angle:4.66rad)
cetz.draw.content((-0.72, -0.36),angle:4.66rad,[q])
cetz.draw.hobby((-0.66, -0.68),(-0.66, -0.35),(-0.62, -0.03),stroke:stroke,mark: (end: ">"))
...
edge(node3.pos,(-0.15, 0.15),node5.pos,decoration:"arrow",angle:-1.91rad)
edge(node1.pos,(-1.00, -1.00),decoration:"arrow",angle:-2.91rad)
...
cetz.draw.content((0.18, 0.20),angle:5.49rad,[q+k[3]])
...
cetz.draw.hobby((-0.77, 0.57),(-0.41, 0.55),(-0.06, 0.52),stroke:stroke,mark: (end: ">"))
...
edge(node2.pos,(-0.50, 0.42),node4.pos,decoration:"arrow",angle:5.22rad)
cetz.draw.content((-0.60, 0.36),angle:5.22rad,[p+k[3]])
cetz.draw.hobby((-0.64, 0.63),(-0.54, 0.37),(-0.36, 0.16),stroke:stroke,mark: (end: ">"))
...
cetz.draw.hobby((-0.24, 0.28),(0.09, 0.54),(0.47, 0.73),stroke:stroke,mark: (end: ">"))
...
edge(node3.pos,(1.00, 1.00),decoration:"coil",angle:3.75rad)
...
edge(node5.pos,(-0.64, -0.43),node1.pos,decoration:"wave",angle:1.86rad)
...
edge(node5.pos,(0.49, 0.41),node2.pos,decoration:"arrow",angle:1.07rad)
cetz.draw.content((0.60, 0.36),angle:1.07rad,[k[3]])
...
cetz.draw.hobby((0.52, 0.32),(0.06, 0.19),(-0.42, 0.12),stroke:stroke,mark: (end: ">"))
edge(node4.pos,(-0.15, 0.14),node3.pos,decoration:"arrow",angle:1.23rad)
cetz.draw.content((-0.03, 0.10),angle:1.23rad,[p+2 q+2 k[3]])
cetz.draw.hobby((-0.22, -0.18),(-0.09, 0.11),(-0.01, 0.41),stroke:stroke,mark: (end: ">"))
...
cetz.draw.hobby((0.66, 0.58),(0.34, 0.61),(0.01, 0.61),stroke:stroke,mark: (end: ">"))
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding3i0 -3+9+13],box[#embedding3i1 -3+11],)
pagebreak()
[== final
Denominator: 
```mathematica
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding4i0 -3+15-17],box[#embedding4i1 -3+9],box[#embedding4i2 -3+11-13],)
pagebreak()
[== final
Denominator: 
```mathematica
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding7f0 -1+9-11],box[#embedding7f1 -1-13],)
pagebreak()
...
-1/2 (1/2 dot[p,p]-dot[p,q]+1/2 dot[q,q])^-1 (1/2 dot[p,p]+dot[p,q]+1/2 dot[q,q])^-1 prop[0,k[3]]^-1 prop[0,q+k[3]]^-1 prop[0,-p-k[3]]^-1
	...
	-1/4 (1/2 dot[p,p]+dot[p,q]+1/2 dot[q,q])^-1 prop[0,q+k[3]]^-1 prop[0,-p-k[3]]^-1 prop[0,-p-q-k[3]]^-1 dot[p,q]^-1
```]
grid(columns: cols,gutter: 20pt,box[#embedding8i0 -3-13-15],box[#embedding8i1 -3-11-17],)
pagebreak()
[== final
Denominator: 
```mathematica
