...
cetz.draw.content((0.06, -0.89),angle:0.15rad,[0])
...
cetz.draw.content((-0.75, -0.54),angle:4.97rad,[0])
...
cetz.draw.content((0.82, -0.14),angle:1.42rad,[0])
...
cetz.draw.content((-0.23, 0.38),angle:4.75rad,[0])
...
edge(node5.pos,(1.00, 1.00),decoration:"arrow",angle:1.17rad)
cetz.draw.content((0.77, 0.77),angle:1.17rad,[k[3]])
cetz.draw.hobby((0.74, 0.55),(0.91, 0.93),stroke:stroke,mark: (end: ">"))
edge(node4.pos,(-0.35, -0.01),node3.pos,decoration:"arrow",angle:-2.72rad)
cetz.draw.content((-0.30, -0.12),angle:-2.72rad,[0])
cetz.draw.hobby((-0.60, -0.19),(-0.31, -0.06),(-0.03, 0.07),stroke:stroke,mark: (end: ">"))
edge(node3.pos,(0.41, 0.30),node5.pos,decoration:"arrow",angle:-2.78rad)
cetz.draw.content((0.45, 0.19),angle:-2.78rad,[0])
...
edge(node0.pos,(-0.15, -0.74),node1.pos,decoration:"arrow",angle:6.17rad)
...
cetz.draw.content((0.10, -0.92),angle:0.19rad,[0])
...
cetz.draw.hobby((-0.55, -0.95),(-0.89, -1.04),stroke:stroke,mark: (end: ">"))
edge(node0.pos,(-0.40, -0.56),node4.pos,decoration:"wave",angle:4.48rad)
cetz.draw.content((-0.52, -0.53),angle:4.48rad,[0])
...
cetz.draw.content((0.75, -0.13),angle:1.56rad,[0])
...
cetz.draw.content((-0.03, 0.11),angle:1.24rad,[0])
...
cetz.draw.content((0.70, 0.77),angle:0.98rad,[k[3]])
...
cetz.draw.content((-0.65, -0.14),angle:5.22rad,[0])
...
cetz.draw.content((0.11, 0.14),angle:-2.92rad,[0])
...
edge(node4.pos,(0.14, 0.14),node3.pos,decoration:"arrow",angle:5.05rad)
...
cetz.draw.content((0.07, -0.81),angle:0.12rad,[0])
...
edge(node0.pos,(-0.54, -0.35),node4.pos,decoration:"wave",angle:4.76rad)
cetz.draw.content((-0.66, -0.35),angle:4.76rad,[0])
cetz.draw.hobby((-0.57, -0.66),(-0.60, -0.34),(-0.61, -0.01),stroke:stroke,mark: (end: ">"))
edge(node5.pos,(0.69, -0.05),node1.pos,decoration:"wave",angle:1.45rad)
cetz.draw.content((0.81, -0.07),angle:1.45rad,[0])
...
cetz.draw.content((-0.35, 0.83),angle:-0.27rad,[0])
...
cetz.draw.content((-0.82, 0.36),angle:1.85rad,[0])
cetz.draw.hobby((-0.81, 0.68),(-0.76, 0.37),(-0.63, 0.09),stroke:stroke,mark: (end: ">"))
edge(node2.pos,(-1.00, 1.00),decoration:"arrow",angle:5.51rad)
cetz.draw.content((-0.96, 0.79),angle:5.51rad,[-p])
...
cetz.draw.content((-0.19, 0.20),angle:-2.35rad,[0])
...
cetz.draw.content((0.36, 0.67),angle:3.08rad,[0])
...
cetz.draw.content((-0.12, -0.87),angle:6.17rad,[0])
...
cetz.draw.content((-0.96, -0.17),angle:4.97rad,[0])
...
cetz.draw.content((0.50, -0.38),angle:1.79rad,[0])
...
cetz.draw.content((0.52, 0.33),angle:3.79rad,[0])
...
cetz.draw.content((-0.63, 0.45),angle:2.40rad,[0])
...
cetz.draw.content((-0.12, 0.18),angle:2.98rad,[0])
...
edge(node2.pos,(0.28, 0.28),node4.pos,decoration:"arrow",angle:2.36rad)
...
cetz.draw.content((-0.07, -0.84),angle:6.16rad,[0])
...
cetz.draw.content((-0.91, -0.13),angle:4.98rad,[0])
...
cetz.draw.content((0.76, -0.46),angle:1.28rad,[0])
...
cetz.draw.content((0.00, 0.61),angle:0.35rad,[0])
...
cetz.draw.content((-0.62, 0.58),angle:-0.41rad,[0])
...
cetz.draw.content((0.78, 0.35),angle:1.80rad,[0])
...
edge(node4.pos,(-0.14, 0.50),node3.pos,decoration:"arrow",angle:-0.57rad)
...
cetz.draw.content((0.07, -0.84),angle:0.12rad,[0])
...
cetz.draw.content((-0.75, -0.46),angle:5.01rad,[0])
...
cetz.draw.content((0.91, -0.13),angle:1.30rad,[0])
...
cetz.draw.content((-0.00, 0.61),angle:2.80rad,[0])
...
cetz.draw.content((0.63, 0.58),angle:0.41rad,[0])
...
cetz.draw.content((-0.78, 0.35),angle:4.48rad,[0])
...
edge(node0.pos,(0.67, -0.47),node4.pos,decoration:"wave",angle:-1.68rad)
edge(node5.pos,(0.10, -0.07),node1.pos,decoration:"wave",angle:0.96rad)
...
edge(node0.pos,(0.40, -0.30),node4.pos,decoration:"wave",angle:-1.31rad)
...
edge(node5.pos,(-0.50, 0.41),node2.pos,decoration:"arrow",angle:5.24rad)
edge(node4.pos,(0.49, 0.41),node3.pos,decoration:"arrow",angle:-2.09rad)
...
cetz.draw.content((-0.10, -0.92),angle:6.09rad,[0])
...
cetz.draw.content((-0.74, -0.14),angle:4.73rad,[0])
...
cetz.draw.content((0.52, -0.53),angle:1.80rad,[0])
...
cetz.draw.content((-0.11, 0.14),angle:6.06rad,[0])
cetz.draw.hobby((0.42, 0.12),(-0.06, 0.19),(-0.52, 0.32),stroke:stroke,mark: (end: ">"))
edge(node5.pos,(0.54, -0.08),node2.pos,decoration:"arrow",angle:-2.07rad)
cetz.draw.content((0.65, -0.14),angle:-2.07rad,[0])
...
cetz.draw.content((0.03, 0.11),angle:1.91rad,[0])
cetz.draw.hobby((0.01, 0.42),(0.10, 0.11),(0.22, -0.18),stroke:stroke,mark: (end: ">"))
})
...
edge(node5.pos,(-0.14, 0.14),node2.pos,decoration:"arrow",angle:-1.90rad)
edge(node4.pos,(0.09, 0.26),node3.pos,decoration:"arrow",angle:0.22rad)
...
cetz.draw.content((-0.07, -0.82),angle:6.16rad,[0])
...
cetz.draw.content((-0.81, -0.07),angle:4.83rad,[0])
...
cetz.draw.content((0.67, -0.36),angle:1.51rad,[0])
cetz.draw.hobby((0.61, -0.02),(0.61, -0.35),(0.58, -0.67),stroke:stroke,mark: (end: ">"))
edge(node3.pos,(0.39, 0.71),node2.pos,decoration:"coil",angle:0.28rad)
cetz.draw.content((0.36, 0.82),angle:0.28rad,[0])
...
cetz.draw.content((-0.35, 0.66),angle:0.05rad,[0])
...
cetz.draw.content((0.20, 0.19),angle:5.50rad,[0])
...
cetz.draw.content((-0.97, 0.70),angle:2.07rad,[p])
...
cetz.draw.content((0.83, 0.35),angle:1.29rad,[0])
...
cetz.draw.content((0.13, -0.87),angle:0.11rad,[0])
...
cetz.draw.content((-0.50, -0.38),angle:4.50rad,[0])
cetz.draw.hobby((-0.49, -0.69),(-0.44, -0.39),(-0.36, -0.08),stroke:stroke,mark: (end: ">"))
edge(node5.pos,(0.85, -0.14),node1.pos,decoration:"wave",angle:1.31rad)
cetz.draw.content((0.96, -0.17),angle:1.31rad,[0])
...
edge(node3.pos,(-1.00, 0.00),decoration:"coil",angle:1.37rad)
cetz.draw.content((-0.84, 0.20),angle:1.37rad,[p+q+k[3]])
...
cetz.draw.content((0.12, 0.18),angle:0.17rad,[0])
cetz.draw.hobby((0.48, 0.17),(0.13, 0.12),(-0.21, 0.05),stroke:stroke,mark: (end: ">"))
edge(node5.pos,(0.71, 0.36),node2.pos,decoration:"arrow",angle:0.74rad)
cetz.draw.content((0.63, 0.45),angle:0.74rad,[0])
...
cetz.draw.content((-0.52, 0.33),angle:-0.65rad,[0])
...
edge(node4.pos,(0.35, 0.54),node3.pos,decoration:"arrow",angle:-0.06rad)
edge(node3.pos,(-0.28, 0.28),node5.pos,decoration:"arrow",angle:0.78rad)
})
...
cetz.draw.content((-0.75, -0.54),angle:4.96rad,[0])
...
cetz.draw.content((-0.23, 0.38),angle:1.61rad,[0])
...
cetz.draw.content((-0.29, -0.12),angle:0.42rad,[0])
...
cetz.draw.content((0.46, 0.19),angle:0.36rad,[0])
...
cetz.draw.content((-0.90, -0.19),angle:2.66rad,[p+q+k[3]])
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding7i0 +2-3+14-15],box[#embedding7i1 +2-3+8-9+16-17],)
pagebreak()
[== final
Denominator: 
```mathematica
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding7f0 +0-1+10-11],box[#embedding7f1 +0-1+8-9+12-13],)
pagebreak()
