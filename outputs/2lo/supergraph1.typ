...
node(node5.pos)
edge(node0.pos,(-0.13, -0.74),node1.pos,decoration:"arrow",angle:-3.02rad)
...
cetz.draw.hobby((0.36, -0.92),(-0.08, -0.87),(-0.50, -0.76),stroke:stroke,mark: (end: ">"))
...
edge(node5.pos,(0.41, -0.55),node1.pos,decoration:"wave",angle:1.79rad)
cetz.draw.content((0.52, -0.53),angle:1.79rad,[q])
cetz.draw.hobby((0.39, -0.26),(0.46, -0.53),(0.52, -0.79),stroke:stroke,mark: (end: ">"))
...
cetz.draw.hobby((0.38, -0.27),(0.60, -0.12),(0.62, 0.14),stroke:stroke,mark: (end: ">"))
...
cetz.draw.content((-0.78, 0.46),angle:1.67rad,[-p-q-2 k[3]])
...
edge(node5.pos,(0.71, 0.37),node2.pos,decoration:"arrow",angle:3.88rad)
...
edge(node5.pos,(-0.36, -0.33),node1.pos,decoration:"wave",angle:1.22rad)
edge(node2.pos,(0.38, 0.56),node4.pos,decoration:"arrow",angle:3.73rad)
...
cetz.draw.hobby((-0.68, 0.80),(-0.38, 0.76),(-0.09, 0.63),stroke:stroke,mark: (end: ">"))
...
cetz.draw.content((-0.84, 0.35),angle:1.85rad,[-p+k[2]])
cetz.draw.hobby((-0.65, 0.08),(-0.78, 0.36),(-0.82, 0.67),stroke:stroke,mark: (end: ">"))
edge(node0.pos,(-1.00, -1.00),decoration:"arrow",angle:-2.66rad)
...
edge(node3.pos,(0.39, 0.70),node2.pos,decoration:"coil",angle:3.42rad)
...
cetz.draw.content((-0.65, -0.14),angle:5.23rad,[p+q+2 k[3]])
cetz.draw.hobby((-0.62, 0.14),(-0.59, -0.12),(-0.37, -0.27),stroke:stroke,mark: (end: ">"))
edge(node5.pos,(0.08, 0.25),node2.pos,decoration:"arrow",angle:-2.92rad)
...
cetz.draw.hobby((-0.45, 0.69),(-0.02, 0.55),(0.40, 0.39),stroke:stroke,mark: (end: ">"))
edge(node5.pos,(0.67, 0.47),node2.pos,decoration:"arrow",angle:3.56rad)
cetz.draw.content((0.62, 0.58),angle:3.56rad,[k[3]])
...
edge(node2.pos,(-0.24, 0.55),node4.pos,decoration:"arrow",angle:-0.51rad)
...
edge(node3.pos,(0.33, 0.35),node5.pos,decoration:"arrow",angle:-2.48rad)
edge(node1.pos,(-1.00, -1.00),decoration:"arrow",angle:-2.67rad)
...
cetz.draw.hobby((-0.55, -0.63),(-0.47, -0.26),(-0.36, 0.09),stroke:stroke,mark: (end: ">"))
...
cetz.draw.hobby((0.68, 0.32),(0.68, -0.13),(0.66, -0.57),stroke:stroke,mark: (end: ">"))
...
cetz.draw.hobby((0.62, 0.54),(0.89, 0.95),stroke:stroke,mark: (end: ">"))
...
cetz.draw.hobby((0.01, 0.60),(0.34, 0.60),(0.66, 0.58),stroke:stroke,mark: (end: ">"))
edge(node0.pos,(-1.00, -1.00),decoration:"arrow",angle:-2.66rad)
cetz.draw.content((-0.70, -0.98),angle:-2.66rad,[-k[0]])
cetz.draw.hobby((-0.88, -1.01),(-0.57, -0.84),stroke:stroke,mark: (end: ">"))
edge(node1.pos,(1.00, -1.00),decoration:"arrow",angle:2.36rad)
...
cetz.draw.content((-0.43, -0.17),angle:4.36rad,[q])
...
cetz.draw.content((-0.30, 0.67),angle:-0.58rad,[p+k[3]])
...
cetz.draw.hobby((0.07, 0.05),(-0.33, 0.25),(-0.64, 0.56),stroke:stroke,mark: (end: ">"))
edge(node4.pos,(0.24, 0.55),node3.pos,decoration:"arrow",angle:0.49rad)
...
edge(node0.pos,(-0.70, -0.05),node4.pos,decoration:"wave",angle:4.84rad)
...
edge(node3.pos,(0.38, 0.72),node2.pos,decoration:"coil",angle:3.41rad)
cetz.draw.content((0.35, 0.83),angle:3.41rad,[p-k[3]])
cetz.draw.hobby((0.08, 0.65),(0.36, 0.78),(0.67, 0.81),stroke:stroke,mark: (end: ">"))
...
cetz.draw.content((0.18, 0.20),angle:5.50rad,[q+k[3]])
...
cetz.draw.hobby((0.26, -0.72),(-0.12, -0.79),(-0.50, -0.82),stroke:stroke,mark: (end: ">"))
...
edge(node2.pos,(0.35, -0.01),node4.pos,decoration:"arrow",angle:5.84rad)
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding1f0 -1-11-17],box[#embedding1f1 -1-13-15],)
pagebreak()
[= embedding 2 [-1, -1, -2, -1] 
 == initial
Denominator:
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding4i0 -3-9-17],box[#embedding4i1 -3-15],)
pagebreak()
[== final
Denominator: 
```mathematica
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding4f0 -1-11],box[#embedding4f1 -1-9-13],)
pagebreak()
[= embedding 5 [-1, -1, -1, 0] 
 == initial
Denominator:
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding5f0 -1-9],box[#embedding5f1 -1-11+13],box[#embedding5f2 -1-15+17],)
pagebreak()
[= embedding 6 [-1, -1, 0, -1] 
 == initial
Denominator:
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding8f0 -1+9],box[#embedding8f1 -1+11-13],box[#embedding8f2 -1+15-17],)
pagebreak()
[= embedding 9 [-1, 0, -1, 0] 
 == initial
Denominator:
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding9i0 -3-9],box[#embedding9i1 -3-15+17],box[#embedding9i2 -3-11+13],)
pagebreak()
[== final
Denominator: 
```mathematica
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding11f0 -1+17],box[#embedding11f1 -1-9+15],)
pagebreak()
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding13f0 -1+15],box[#embedding13f1 -1+9+17],)
pagebreak()
...
prop[0,k[3]]^-1 prop[0,q+k[3]]^-1 prop[0,p-k[3]]^-1 prop[0,p-q-k[3]]^-1 prop[0,p-q-2 k[3]]^-1
```]
grid(columns: cols,gutter: 20pt,box[#embedding14f0 -1+11+17],box[#embedding14f1 -1+13+15],)
pagebreak()
