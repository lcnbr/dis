...
edge(node3.pos,(0.66, 0.49),node2.pos,decoration:"coil",angle:1.77rad)
...
cetz.draw.hobby((0.59, 0.83),(0.88, 1.00),stroke:stroke,mark: (end: ">"))
...
cetz.draw.content((0.60, 0.83),angle:0.67rad,[p-k[3]])
...
cetz.draw.content((0.66, -0.14),angle:-2.07rad,[q+k[3]])
...
cetz.draw.content((0.12, -0.86),angle:-3.03rad,[q+k[0]])
...
cetz.draw.hobby((0.53, 0.19),(0.66, 0.40),(0.87, 0.53),stroke:stroke,mark: (end: ">"))
...
cetz.draw.content((-0.00, -0.87),angle:3.08rad,[q+k[0]])
cetz.draw.hobby((0.40, -0.81),(-0.00, -0.81),(-0.39, -0.77),stroke:stroke,mark: (end: ">"))
...
cetz.draw.content((-0.42, 0.24),angle:2.48rad,[k[3]])
...
cetz.draw.hobby((-0.58, -0.12),(-0.28, 0.07),(0.01, 0.28),stroke:stroke,mark: (end: ">"))
...
cetz.draw.content((0.10, 0.08),angle:5.33rad,[p+k[3]])
...
edge(node2.pos,(0.67, 0.47),node4.pos,decoration:"arrow",angle:0.42rad)
...
cetz.draw.content((0.59, 0.36),angle:1.07rad,[k[3]])
cetz.draw.hobby((0.36, 0.15),(0.53, 0.37),(0.64, 0.64),stroke:stroke,mark: (end: ">"))
...
edge(node4.pos,(0.20, 0.14),node3.pos,decoration:"arrow",angle:2.19rad)
...
edge(node5.pos,(-0.67, 0.47),node2.pos,decoration:"arrow",angle:-0.40rad)
...
cetz.draw.content((-0.01, 0.50),angle:2.92rad,[-p-q-k[3]])
...
edge(node3.pos,(0.13, 0.39),node2.pos,decoration:"coil",angle:-1.55rad)
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding3i0 -3+11],box[#embedding3i1 -3+9+13],)
pagebreak()
[== final
Denominator: 
```mathematica
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding3f0 -1+9+17],box[#embedding3f1 -1+15],)
pagebreak()
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding4i0 -3+9],box[#embedding4i1 -3+11-13],box[#embedding4i2 -3+15-17],)
pagebreak()
[== final
Denominator: 
```mathematica
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding4f0 -1-13+15],)
pagebreak()
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding5f0 -1-11+17],)
pagebreak()
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding6i0 -3+9-17],)
pagebreak()
[== final
Denominator: 
```mathematica
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding6f0 -1+9-13],)
pagebreak()
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding7i0 -3+9-15],box[#embedding7i1 -3-17],)
pagebreak()
[== final
Denominator: 
```mathematica
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding7f0 -1-13],box[#embedding7f1 -1+9-11],)
pagebreak()
...
-1/2 (1/2 dot[p,p]-dot[p,q]+1/2 dot[q,q])^-1 (1/2 dot[p,p]+dot[p,q]+1/2 dot[q,q])^-1 prop[0,k[3]]^-1 prop[0,q+k[3]]^-1 prop[0,-p-k[3]]^-1
	...
	-1/4 (1/2 dot[p,p]+dot[p,q]+1/2 dot[q,q])^-1 prop[0,q+k[3]]^-1 prop[0,-p-k[3]]^-1 prop[0,-p-q-k[3]]^-1 dot[p,q]^-1
```]
grid(columns: cols,gutter: 20pt,box[#embedding8i0 -3-11-17],box[#embedding8i1 -3-13-15],)
pagebreak()
[== final
Denominator: 
```mathematica
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding8f0 -1-11-13],)
pagebreak()
}