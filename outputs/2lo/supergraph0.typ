...
cetz.draw.hobby((-0.05, -0.14),(-0.29, -0.14),(-0.47, 0.03),stroke:stroke,mark: (end: ">"))
...
edge(node5.pos,(0.72, -0.13),node1.pos,decoration:"wave",angle:1.47rad)
...
cetz.draw.hobby((0.47, 0.52),(0.73, 0.62),(0.83, 0.89),stroke:stroke,mark: (end: ">"))
edge(node5.pos,(0.20, 0.32),node2.pos,decoration:"arrow",angle:4.07rad)
...
edge(node3.pos,(-0.01, 0.97),node2.pos,decoration:"arrow",angle:3.12rad)
edge(node2.pos,(-0.02, 0.68),node3.pos,decoration:"coil",angle:3.12rad)
...
cetz.draw.content((-0.82, -0.17),angle:4.80rad,[q])
...
cetz.draw.hobby((-0.67, 0.28),(-0.37, 0.07),(-0.06, -0.13),stroke:stroke,mark: (end: ">"))
edge(node0.pos,(-1.00, -1.00),decoration:"arrow",angle:-2.43rad)
cetz.draw.content((-0.74, -0.93),angle:-2.43rad,[-k[0]])
cetz.draw.hobby((-0.89, -0.98),(-0.67, -0.79),stroke:stroke,mark: (end: ">"))
edge(node1.pos,(1.00, -1.00),decoration:"arrow",angle:2.86rad)
...
cetz.draw.content((-0.01, 1.09),angle:-0.02rad,[k[2]])
cetz.draw.hobby((-0.29, 0.91),(-0.02, 1.03),(0.25, 0.90),stroke:stroke,mark: (end: ">"))
edge(node2.pos,(-0.02, 0.68),node3.pos,decoration:"coil",angle:6.27rad)
cetz.draw.content((-0.03, 0.56),angle:6.27rad,[-p-q+k[2]])
...
cetz.draw.hobby((0.81, 0.61),(0.57, 0.73),(0.33, 0.84),stroke:stroke,mark: (end: ">"))
...
edge(node4.pos,(-0.39, 0.22),node5.pos,decoration:"arrow",angle:-0.46rad)
edge(node1.pos,(-1.00, -1.00),decoration:"arrow",angle:-2.36rad)
edge(node0.pos,(1.00, -1.00),decoration:"arrow",angle:2.74rad)
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding8f0 -1+9-10],box[#embedding8f1 -1-12],box[#embedding8f2 -1-14],)
pagebreak()
[= embedding 9 [1, 1, 1, 1] 
 == initial
Denominator:
