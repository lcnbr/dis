...
cetz.draw.hobby((0.29, 0.06),(-0.00, 0.02),(-0.30, 0.06),stroke:stroke,mark: (end: ">"))
...
cetz.draw.hobby((-0.99, 0.88),(-0.76, 0.54),stroke:stroke,mark: (end: ">"))
...
cetz.draw.content((0.62, 0.78),angle:-0.46rad,[-p-q])
...
edge(node0.pos,(0.74, -0.13),node4.pos,decoration:"wave",angle:-1.67rad)
edge(node5.pos,(-0.22, -0.38),node1.pos,decoration:"wave",angle:1.10rad)
edge(node3.pos,(-0.59, 0.75),node2.pos,decoration:"arrow",angle:-0.71rad)
...
edge(node3.pos,(0.48, 0.87),node2.pos,decoration:"arrow",angle:0.77rad)
edge(node2.pos,(0.70, 0.65),node3.pos,decoration:"coil",angle:0.83rad)
...
edge(node0.pos,(0.48, -0.48),node4.pos,decoration:"wave",angle:-1.40rad)
edge(node5.pos,(-0.47, -0.49),node1.pos,decoration:"wave",angle:1.41rad)
edge(node5.pos,(-0.65, 0.20),node2.pos,decoration:"arrow",angle:-0.80rad)
...
edge(node0.pos,(-0.24, -0.49),node4.pos,decoration:"wave",angle:4.23rad)
cetz.draw.content((-0.34, -0.44),angle:4.23rad,[q])
...
cetz.draw.hobby((0.79, 0.27),(0.77, -0.16),(0.71, -0.59),stroke:stroke,mark: (end: ">"))
...
edge(node3.pos,(-0.64, 0.71),node2.pos,decoration:"arrow",angle:2.40rad)
cetz.draw.content((-0.56, 0.80),angle:2.40rad,[k[2]])
cetz.draw.hobby((-0.50, 0.48),(-0.60, 0.75),(-0.87, 0.84),stroke:stroke,mark: (end: ">"))
edge(node2.pos,(-0.87, 0.48),node3.pos,decoration:"coil",angle:2.34rad)
cetz.draw.content((-0.95, 0.40),angle:2.34rad,[p+k[2]])
cetz.draw.hobby((-0.99, 0.71),(-0.90, 0.43),(-0.62, 0.35),stroke:stroke,mark: (end: ">"))
edge(node3.pos,(-0.30, 0.22),node4.pos,decoration:"arrow",angle:2.48rad)
cetz.draw.content((-0.23, 0.31),angle:2.48rad,[p])
cetz.draw.hobby((-0.48, 0.43),(-0.26, 0.27),(-0.05, 0.09),stroke:stroke,mark: (end: ">"))
edge(node4.pos,(0.36, 0.22),node5.pos,decoration:"arrow",angle:3.62rad)
cetz.draw.content((0.31, 0.33),angle:3.62rad,[p+q])
...
cetz.draw.content((-1.07, 0.84),angle:1.90rad,[p])
cetz.draw.hobby((-1.02, 0.89),(-1.01, 0.84),stroke:stroke,mark: (end: ">"))
})
...
edge(node3.pos,(0.70, 0.66),node2.pos,decoration:"arrow",angle:-2.32rad)
cetz.draw.content((0.79, 0.58),angle:-2.32rad,[k[2]])
cetz.draw.hobby((0.83, 0.88),(0.74, 0.61),(0.47, 0.51),stroke:stroke,mark: (end: ">"))
edge(node2.pos,(0.48, 0.88),node3.pos,decoration:"coil",angle:3.90rad)
cetz.draw.content((0.39, 0.97),angle:3.90rad,[p+k[2]])
cetz.draw.hobby((0.34, 0.63),(0.43, 0.91),(0.70, 1.01),stroke:stroke,mark: (end: ">"))
edge(node5.pos,(0.21, 0.31),node2.pos,decoration:"arrow",angle:-2.22rad)
cetz.draw.content((0.30, 0.24),angle:-2.22rad,[p])
cetz.draw.hobby((0.09, 0.05),(0.26, 0.27),(0.42, 0.49),stroke:stroke,mark: (end: ">"))
edge(node4.pos,(-0.39, 0.23),node5.pos,decoration:"arrow",angle:2.69rad)
cetz.draw.content((-0.34, 0.34),angle:2.69rad,[p+q])
cetz.draw.hobby((-0.66, 0.42),(-0.35, 0.28),(-0.05, 0.13),stroke:stroke,mark: (end: ">"))
edge(node0.pos,(-1.00, -1.00),decoration:"arrow",angle:-2.35rad)
...
edge(node3.pos,(1.00, 1.00),decoration:"arrow",angle:3.41rad)
cetz.draw.content((0.85, 1.08),angle:3.41rad,[p])
...
edge(node2.pos,(-0.02, 0.97),node3.pos,decoration:"coil",angle:3.13rad)
...
cetz.draw.hobby((0.45, -0.06),(0.52, -0.38),(0.57, -0.71),stroke:stroke,mark: (end: ">"))
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding2f0 -1-9-12],box[#embedding2f1 -1-9-14],box[#embedding2f2 -1-10],)
pagebreak()
[= embedding 3 [-1, -1, 0, -1] 
 == initial
Denominator:
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding3f0 -1-14],box[#embedding3f1 -1-12],box[#embedding3f2 -1+9-10],)
pagebreak()
[= embedding 4 [-1, -1, 1, -1] 
 == initial
Denominator:
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding5f0 -1+9],box[#embedding5f1 -1+10-14],box[#embedding5f2 -1+10-12],)
pagebreak()
[= embedding 6 [-1, 0, -1, 0] 
 == initial
Denominator:
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding7i0 -3-9+14],box[#embedding7i1 -3-9+12],)
pagebreak()
[== final
Denominator: 
```mathematica
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding8i0 -3-9+10],box[#embedding8i1 -3+12],box[#embedding8i2 -3+14],)
pagebreak()
[== final
Denominator: 
```mathematica
...
prop[0,k[3]]^-2 prop[0,q+k[3]]^-1 prop[0,p-k[3]]^-1 dot[p,p]^-1
```]
grid(columns: cols,gutter: 20pt,box[#embedding9i0 -3+9+14],box[#embedding9i1 -3+10],box[#embedding9i2 -3+9+12],)
pagebreak()
[== final
Denominator: 
```mathematica
