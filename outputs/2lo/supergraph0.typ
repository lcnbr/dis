...
edge(node5.pos,(0.70, -0.16),node1.pos,decoration:"wave",angle:1.49rad)
cetz.draw.content((0.82, -0.17),angle:1.49rad,[q])
...
cetz.draw.hobby((0.42, -0.86),(0.00, -0.89),(-0.41, -0.87),stroke:stroke,mark: (end: ">"))
edge(node0.pos,(-0.46, -0.40),node4.pos,decoration:"wave",angle:4.52rad)
cetz.draw.content((-0.58, -0.38),angle:4.52rad,[q])
cetz.draw.hobby((-0.56, -0.71),(-0.52, -0.38),(-0.43, -0.06),stroke:stroke,mark: (end: ">"))
...
edge(node4.pos,(0.01, 0.00),node5.pos,decoration:"arrow",angle:3.15rad)
...
cetz.draw.content((0.32, -0.29),angle:2.04rad,[q])
cetz.draw.hobby((0.10, 0.00),(0.27, -0.31),(0.42, -0.63),stroke:stroke,mark: (end: ">"))
edge(node3.pos,(0.46, 0.91),node2.pos,decoration:"arrow",angle:3.88rad)
cetz.draw.content((0.38, 1.00),angle:3.88rad,[k[2]])
cetz.draw.hobby((0.69, 1.04),(0.41, 0.95),(0.33, 0.66),stroke:stroke,mark: (end: ">"))
edge(node2.pos,(0.68, 0.69),node3.pos,decoration:"coil",angle:-2.34rad)
cetz.draw.content((0.77, 0.60),angle:-2.34rad,[p+k[2]])
cetz.draw.hobby((0.46, 0.54),(0.72, 0.64),(0.82, 0.91),stroke:stroke,mark: (end: ">"))
edge(node5.pos,(0.20, 0.33),node2.pos,decoration:"arrow",angle:-2.19rad)
cetz.draw.content((0.30, 0.26),angle:-2.19rad,[p])
cetz.draw.hobby((0.09, 0.07),(0.25, 0.30),(0.41, 0.52),stroke:stroke,mark: (end: ">"))
...
cetz.draw.content((0.85, 1.10),angle:3.30rad,[p])
...
edge(node3.pos,(-1.00, 1.00),decoration:"coil",angle:1.71rad)
...
cetz.draw.hobby((-1.01, 0.70),(-0.92, 0.43),(-0.63, 0.34),stroke:stroke,mark: (end: ">"))
...
cetz.draw.content((-1.08, 0.85),angle:1.82rad,[p])
...
edge(node5.pos,(-0.59, 0.68),node2.pos,decoration:"arrow",angle:3.62rad)
...
node(node5.pos)
edge(node0.pos,(0.13, -0.77),node1.pos,decoration:"arrow",angle:-3.04rad)
...
edge(node2.pos,(-0.01, 0.69),node3.pos,decoration:"coil",angle:0.00rad)
cetz.draw.content((-0.01, 0.57),angle:0.00rad,[-p-q+k[2]])
...
edge(node3.pos,(-0.58, 0.67),node4.pos,decoration:"arrow",angle:0.49rad)
...
cetz.draw.hobby((0.81, 0.64),(0.91, 0.93),stroke:stroke,mark: (end: ">"))
})
...
edge(node4.pos,(-0.38, 0.23),node5.pos,decoration:"arrow",angle:-0.45rad)
edge(node1.pos,(-1.00, -1.00),decoration:"arrow",angle:-2.36rad)
edge(node0.pos,(1.00, -1.00),decoration:"arrow",angle:2.74rad)
...
edge(node3.pos,(1.00, 1.00),decoration:"coil",angle:0.41rad)
})
...
cetz.draw.hobby((0.72, 0.39),(0.72, -0.07),(0.66, -0.52),stroke:stroke,mark: (end: ">"))
...
edge(node5.pos,(0.13, 0.41),node2.pos,decoration:"arrow",angle:0.33rad)
cetz.draw.content((0.10, 0.52),angle:0.33rad,[k[3]])
...
```]
grid(columns: cols,gutter: 20pt,box[#embedding8f0 -1-12],box[#embedding8f1 -1+9-10],box[#embedding8f2 -1-14],)
pagebreak()
[= embedding 9 [1, 1, 1, 1] 
 == initial
Denominator:
